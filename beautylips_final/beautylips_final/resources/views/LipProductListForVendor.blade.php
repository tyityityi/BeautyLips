    ...
    <div class="col-3 filter">
        <div class="p-4 m-4">
            ...
            <ul class="list-unstyled">
                <li><a class="btn btn-sm btn-outline-secondary" href="/vendorCenter/Lip/lipstick">Lipstick</a></li>
                <li><a class="btn btn-sm btn-outline-secondary" href="/vendorCenter/Lip/lip gloss">Lip Gloss</a></li>
                <li><a class="btn btn-sm btn-outline-secondary" href="/vendorCenter/Lip/lip linear">Lip Linear</a></li>
                <li><a class="btn btn-sm btn-outline-secondary" href="/vendorCenter/Lip/liquid lipstick">Liquid Lipstick</a></li>
            </ul>
        </div>
    </div>
    <div class="col-9">
        ...
        <div class="col-md-4 my-4">
            <div class="card box-shadow">
                <p class="card-text text-center mb-0">{{$product->productID}}</p>
