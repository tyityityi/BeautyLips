...
<!--         <div class="row w-100 ">
            <div id="msg" class="alert alert-dismissable alert-success w-100" hidden="hidden">
        ...
        <div class="row w-100 justify-content-end">
            ...
            <a class="btn btn-sm btn-outline-secondary" href="{{ url('vendor/login') }}">Login in as Vendor</a>
            <a class="btn btn-sm btn-outline-secondary" href="{{ route('login') }}">Login in as Customer</a> @else
        ...
        <div class="row d-flex justify-content-between align-items-center w-100 py-2">
            <div class="col-6 mb-4">
                <a class="text-dark" href="/" style="text-decoration: none"><h1 class="display-3">Beauty Lips</a>
            </div>
                ...
                <nav class="nav d-flex justify-content-between">
                    <div class="btn-group col-2 p-0">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="/productlist/brand/3CE">3CE</a>
                            <a class="dropdown-item" href="/productlist/brand/Charlotte Tilbury">Charlotte Tilbury</a>
                            <a class="dropdown-item" href="/productlist/brand/Huda Beauty">Huda Beauty</a>
                            <a class="dropdown-item" href="/productlist/brand/SHISEIDO">SHISEIDO</a>
                            <a class="dropdown-item" href="/productlist/brand/Kevyn Aucoin">Kevyn Aucoin</a>
                            <a class="dropdown-item" href="/productlist/brand/TOM FORD">TOM FORD</a>
                        </div>
                    </div>
                    <div class="btn-group col-2 p-0">
                        <button class="btn btn-light btn-lg dropdown-toggle w-100" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="/productlist/lip/Lipstick">Lipstick</a>
                            <a class="dropdown-item" href="/productlist/lip/Lip Linear">Lip Linear</a>
                            <a class="dropdown-item" href="/productlist/lip/Liquid Lipstick">Liquid Lipstick</a>
                            <a class="dropdown-item" href="/productlist/lip/Lip Gloss">Lip Gloss</a>
                        </div>
                    </div>
                    <div class="btn-group col-2 p-0">
                        <button class="btn btn-light btn-lg dropdown-toggle w-100" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="/productlist/texture/Matte">Matte</a>
                            <a class="dropdown-item" href="/productlist/texture/Cream">Cream</a>
                            <a class="dropdown-item" href="/productlist/texture/Satin">Satin</a>
                            <a class="dropdown-item" href="/productlist/texture/Sheer">Sheer</a>
                        </div>
                    </div>
                    <div class="col-6 row justify-content-end">
                        @if(str_replace(url('/'), '', url()->current()) === "")
                        <form id="myform" class="form-inline mt-2 mt-md-0" method="get" action="/productlist">
                            @else
                            <form id="myform" class="form-inline mt-2 mt-md-0" method="get" action="">
                                @endif
                                <input class="form-control mr-sm-2 col-9" type="text" placeholder="Search" aria-label="Search" name="search">
                                <a class="text-dark" href="#" onclick="document.getElementById('myform').submit()">
    ...
    <div class="container" style="margin-top: 15rem;">
        @include('partials.errors') @include('partials.success') @yield('content')
    </div>
    <hr>
