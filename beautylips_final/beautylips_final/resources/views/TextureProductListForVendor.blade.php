    ...
    <div class="col-3 filter">
        <div class="p-4 m-4">
            ...
            <ul class="list-unstyled">
                <li><a class="btn btn-sm btn-outline-secondary" href="/vendorCenter/Texture/matte">Matte</a></li>
                <li><a class="btn btn-sm btn-outline-secondary" href="/vendorCenter/Texture/cream">Cream</a></li>
                <li><a class="btn btn-sm btn-outline-secondary" href="/vendorCenter/Texture/satin">Satin</a></li>
                <li><a class="btn btn-sm btn-outline-secondary" href="/vendorCenter/Texture/sheer">Sheer</a></li>
            </ul>
        </div>
    </div>
    <div class="col-9">
