        ...
        <div class="row">
            <div class="col-3">
                ...
                <div class="custom-control custom-checkbox" style="font-size: 1.2rem">
                    <input name='Currentcheck' type="checkbox" class="custom-control-input" id="CurrentCheck">
                    <label class="custom-control-label" for="CurrentCheck">Current Purchase</label>
                </div>
                <div class="custom-control custom-checkbox" style="font-size: 1.2rem">
                ...
                $('#Filter').on('click', function(event) {
                    if (document.getElementById("CurrentCheck").checked == true && document.getElementById("PastCheck").checked == true) {
                        var href = '/purchaseOrder';

                    } else if (document.getElementById("CurrentCheck").checked == true && document.getElementById("PastCheck").checked == false) { var href = '/purchaseOrder/status/currentP'; } else { var href = '/purchaseOrder/status/shipped'; }
                ...
                <table class="table table-bordered text-center" style="font-size: 1.4rem;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="4">
                                <div class="row">
                                    ...
                                    <div class="col-4 h4"> P.O Number:
                                        <ins>{{$ps->first()->PONum}}</ins>
                                    </div>
                                    <div class="col-4 h4"> Total amount:
                                        <ins>${{$TotalA[$i]}}</ins>
                                    </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td rowspan="1" class="align-middle ">{{$purchase->status}}</td>
                        </tr>
                        @endforeach
                        <tr>
                            <td colspan='4' class="pl-auto">
                                <div class="d-flex justify-content-end" style="font-size: 1.2rem">
                                    <a class="btn btn-dark mx-4 " href="/purchaseOrderDetail/{{$ps->first()->PONum}}" role="button" id="DetailB">Detail</a>
                                </div>
                            </td>
                        </tr>
                        </div>
